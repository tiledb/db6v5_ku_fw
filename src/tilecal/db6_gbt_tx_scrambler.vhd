...
--! by the GBTx.
entity db6_gbt_tx_scrambler is
   generic (
  ...
  port (
      ...
      gbt_cdc_counter_i : in integer range 0 to 3
      
   );
end db6_gbt_tx_scrambler;
...
architecture structural of db6_gbt_tx_scrambler is   
...
--=================================================================================================--
   ...
   gbtTxScrambler84bit_gen: for i in 0 to 3 generate
     ...
     gbtTxScrambler21bit: entity tilecal.db6_gbt_tx_scrambler_21bit
        port map(
           ...
           gbt_cdc_counter_i => gbt_cdc_counter_i,
   ...
   wideBus_gen: if TX_ENCODING = WIDE_BUS or TX_ENCODING = GBT_DYNAMIC generate
      ...
      gbtTxScrambler32bit_gen: for i in 0 to 1 generate
         ...
         gbtTxScrambler16bit: entity tilecal.db6_gbt_tx_scrambler_16bit
            port map(
               TX_RESET_I                       => TX_RESET_I,
