...
architecture structural of db6_gbt_tx is
...
--=================================================================================================--
    ...
    db6_gbt_scrambler: entity tilecal.db6_gbt_tx_scrambler
      generic map (
    ...
    db6_gbt_encoder: entity tilecal.db6_gbt_tx_encoder
      generic map (
        TX_ENCODING                            => TX_ENCODING
      )
      port map (
