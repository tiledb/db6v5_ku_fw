...
entity db6_gbt_tx_encoder_gbtframe_rsencode is
   port (
...
end db6_gbt_tx_encoder_gbtframe_rsencode;
...
architecture structural of db6_gbt_tx_encoder_gbtframe_rsencode is
...
--=================================================================================================--  
   ...
   db6_polyDivider: entity tilecal.db6_gbt_tx_encoder_gbtframe_polydiv
      port map (
