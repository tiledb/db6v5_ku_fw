...
entity db6_gbt_tx_gearbox is
  ...
  port (
    ...
    gbt_cdc_counter_i                        : integer range 0 to 7
  );
end db6_gbt_tx_gearbox;
...
architecture structural of db6_gbt_tx_gearbox is
...
begin 
   ...
   txGearboxStd_gen: if TX_OPTIMIZATION = STANDARD generate
    ...
    txGearboxLatOpt_gen: if TX_OPTIMIZATION = LATENCY_OPTIMIZED generate   
        ...
        txGearboxLatOpt: entity tilecal.db6_gbt_tx_gearbox_latopt
          port map (
