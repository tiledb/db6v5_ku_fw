...
architecture structural of db6_gbt_tx_encoder is 
...
--=================================================================================================--   
   ...
   gbtFrame_gen: if TX_ENCODING = GBT_FRAME or TX_ENCODING = GBT_DYNAMIC generate
      ...
      db6_reedSolomonEncoder60to119: entity tilecal.db6_gbt_tx_encoder_gbtframe_rsencode
         port map (
      ...
      db6_reedSolomonEncoder0to59: entity tilecal.db6_gbt_tx_encoder_gbtframe_rsencode
         port map (
      ...
      db6_interleaver: entity tilecal.db6_gbt_tx_encoder_gbtframe_intlver
         port map (
